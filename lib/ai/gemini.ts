...
Return ONLY the JSON object, nothing else.`;
  ...
  const response = await generateWithGemini(prompt, { temperature: 0.7, maxTokens: 8000 });
...
export async function generateConceptWithGemini(topicTitle: string, curriculumContext: string): Promise<string> {
